      ...
      : EntityType<Data.Database, DatabaseByIdDataLoader>
    {
            ...
            )
        {
            ...
            ConfigureAllDataField<DataX.DataPropositionInput>(
                descriptor,
                "allData",
                _ => _.GetAllDataAsync(default!, default, default, default, default, default, default, default, default!, default)
            );
            ...
            ConfigureAllDataField<DataX.OpticalDataPropositionInput>(
                descriptor,
                "allOpticalData",
                _ => _.GetAllOpticalDataAsync(default!, default, default, default, default, default, default, default, default!, default)
            );
