    ...
    public sealed class InstitutionMethodDeveloperMutations
    {
            ...
            )
        {
            ...
            var institutionMethodDeveloper = new Data.InstitutionMethodDeveloper
            {
                ...
                Pending = !await InstitutionMethodDeveloperAuthorization.IsAuthorizedToConfirm(claimsPrincipal, input.InstitutionId, userManager, context, cancellationToken).ConfigureAwait(false)
            };
