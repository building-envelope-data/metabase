...
namespace Icon.GraphQl
{
    public sealed class CreateComponentVersionInput
    {
        ...
        public CreateComponentVersionInput(
        Guid componentId,
        string name,
        string? abbreviation,
        string description,
        ...
        public static Result<ValueObjects.CreateComponentVersionInput, Errors> Validate(
                CreateComponentVersionInput self,
                ...
                )
        {
            ...
            return
                Errors.CombineExistent(
                    ...
                    .Bind(_ =>
                        ValueObjects.CreateComponentVersionInput.From(
