...
namespace Metabase.Migrations
{
    ...
    [Migration("20260508172623_AddIndicesForNameAndCreatedAtAndAtDefaultValuesForAuditableEntitiesAndAssociations")]
    partial class AddIndicesForNameAndCreatedAtAndAtDefaultValuesForAuditableEntitiesAndAssociations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Metabase.Data.DataFormat", b =>
                {
                    ...
                    b.OwnsOne("Metabase.Data.Reference", "Reference", b1 =>
                        {
                            ...
                            b1.OwnsOne("Metabase.Data.Publication", "Publication", b2 =>
                                {
                                    b2.Property<Guid>("ReferenceDataFormatId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("ReferenceDataFormatId");

                                    b2.ToTable("data_format", "metabase");

                                    b2.WithOwner()
                                        .HasForeignKey("ReferenceDataFormatId");
                                });

                            b1.OwnsOne("Metabase.Data.Standard", "Standard", b2 =>
                                {
                                    b2.Property<Guid>("ReferenceDataFormatId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.OwnsOne("Metabase.Data.Numeration", "Numeration", b3 =>
                                        {
                                            b3.Property<Guid>("StandardReferenceDataFormatId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.HasKey("StandardReferenceDataFormatId");

                                            b3.ToTable("data_format", "metabase");

                                            b3.WithOwner()
                                                .HasForeignKey("StandardReferenceDataFormatId");
                                        });
            ...
            modelBuilder.Entity("Metabase.Data.Institution", b =>
                {
                    ...
                    b.OwnsOne("Metabase.Data.ContactInformation", "Contact", b1 =>
                        {
                            ...
                            b1.Property<bool>("IsEmailAddressConfirmed")
                                .HasColumnType("boolean");

                            b1.Property<bool>("IsPhoneNumberConfirmed")
                                .HasColumnType("boolean");
                            ...
                            b1.Property<string>("WebsiteLocator")
                                .HasColumnType("text");

                            b1.HasKey("InstitutionId");

                            b1.ToTable("institution", "metabase");
            ...
            modelBuilder.Entity("Metabase.Data.Method", b =>
                {
                    ...
                    b.OwnsOne("Metabase.Data.Reference", "Reference", b1 =>
                        {
                            ...
                            b1.OwnsOne("Metabase.Data.Publication", "Publication", b2 =>
                                {
                                    b2.Property<Guid>("ReferenceMethodId")
                                        .HasColumnType("uuid");
                            ...
                            b1.OwnsOne("Metabase.Data.Standard", "Standard", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("Metabase.Data.Numeration", "Numeration", b3 =>
                                        {
                                            b3.Property<Guid>("StandardReferenceMethodId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.HasKey("StandardReferenceMethodId");

                                            b3.ToTable("method", "metabase");

                                            b3.WithOwner()
                                                .HasForeignKey("StandardReferenceMethodId");
                                        });
                    ...
                    b.OwnsMany("Metabase.Data.MethodParameter", "Parameters", b1 =>
                        {
                            b1.Property<Guid>("MethodId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<JsonElement>("Type")
                                .HasColumnType("jsonb");

                            b1.HasKey("MethodId", "Id");

                            b1.ToTable("MethodParameter", "metabase");

                            b1.WithOwner()
                                .HasForeignKey("MethodId");
                        });

                    b.OwnsMany("Metabase.Data.MethodSource", "Sources", b1 =>
                        {
                            b1.Property<Guid>("MethodId")
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("MethodSource", "metabase");
            ...
            modelBuilder.Entity("Metabase.Data.Institution", b =>
                {
                    ...
                    b.Navigation("ManagedComponents");
