...
namespace Metabase.Migrations
{
    ...
    [Migration("20250714160511_InstitutionOpenIdConnectApplicationAssociationProperly")]
    partial class InstitutionOpenIdConnectApplicationAssociationProperly
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Metabase.Data.InstitutionOpenIdConnectApplication", b =>
                {
                    b.Property<Guid>("InstitutionId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("institution_open_id_connect_application", "metabase");
                });
            ...
            modelBuilder.Entity("Metabase.Data.InstitutionOpenIdConnectApplication", b =>
                {
                    ...
                    b.HasOne("Metabase.Data.Institution", "Institution")
                        .WithMany("OpenIdConnectApplicationEdges")
                        .HasForeignKey("InstitutionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Metabase.Data.Institution", b =>
                {
                    ...
                    b.Navigation("OpenIdConnectApplicationEdges");
