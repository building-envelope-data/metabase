...
namespace Metabase.Migrations
{
    ...
    [Migration("20210708152541_RenameDataFormatsTableAndRemoveIdAndXminFromMethodDeveloperRelations")]
    partial class RenameDataFormatsTableAndRemoveIdAndXminFromMethodDeveloperRelations
    {
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasPostgresEnum("public", "component_category", new[] { "material", "layer", "unit" })
                .HasPostgresEnum("public", "institution_representative_role", new[] { "owner", "maintainer", "assistant" })
                .HasPostgresEnum("public", "institution_state", new[] { "unknown", "operative", "inoperative" })
                .HasPostgresEnum("public", "method_category", new[] { "measurement", "calculation" })
                .HasPostgresEnum("public", "standardizer", new[] { "aerc", "agi", "ashrae", "breeam", "bs", "bsi", "cen", "cie", "dgnb", "din", "dvwg", "iec", "ies", "ift", "iso", "jis", "leed", "nfrc", "riba", "ul", "unece", "vdi", "vff", "well" })
