...
namespace Icon.Domain
{
    public sealed class ComponentVersionViewProjection : ViewProjection<ComponentVersionView, Guid>
    {
        public ComponentVersionViewProjection()
        {
            ...
            ProjectEventAsync<ComponentVersionManufacturer.Create.ComponentVersionManufacturerEvent>(e => e.ComponentVersionId, Apply);
        }
        ...
        private async Task Apply(IDocumentSession session, ComponentVersionView view, ComponentVersionManufacturer.Create.ComponentVersionManufacturerEvent @event)
        {
            ...
            var ownership = await session.LoadAsync<ComponentVersionManufacturerView>(@event.ComponentVersionManufacturerId);
            view.Manufacturers.Add(ownership);
        }
    }
}