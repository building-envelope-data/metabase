...
namespace Icon.Web.Api.Controller
{
    ...
    public class ComponentVersionOwnershipsController : ControllerBase
    {
        ...
        /* [HttpGet] */
        /* [AllowAnonymous] */
        /* public async Task<ActionResult<IEnumerable<OwnershipAggregate>>> GetOwnerships() */
        /* { */
        ...
        [HttpPost]
        public async Task<ActionResult<Guid>> Post([FromRoute] Guid componentId, [FromRoute] Guid versionId)
        {
            ...
            var ownership = await _commandBus.Send<ComponentVersionOwnership.Create.Command, ComponentVersionOwnershipAggregate>(
                new ComponentVersionOwnership.Create.Command
                {
