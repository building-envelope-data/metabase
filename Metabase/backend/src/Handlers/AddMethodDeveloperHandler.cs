...
namespace Metabase.Handlers
{
    public sealed class AddMethodDeveloperHandler
      : ICommandHandler<Infrastructure.Commands.AddAssociationCommand<ValueObjects.AddMethodDeveloperInput>, Result<TimestampedId, Errors>>
    {
        private readonly IModelRepository _repository;
        private readonly CreateModelHandler<Infrastructure.Commands.AddAssociationCommand<ValueObjects.AddMethodDeveloperInput>, Aggregates.InstitutionMethodDeveloperAggregate> _addInstitutionMethodDeveloperHandler;
        private readonly CreateModelHandler<Infrastructure.Commands.AddAssociationCommand<ValueObjects.AddMethodDeveloperInput>, Aggregates.PersonMethodDeveloperAggregate> _addPersonMethodDeveloperHandler;

        public AddMethodDeveloperHandler(IModelRepository repository)
        {
            _repository = repository;
            _addInstitutionMethodDeveloperHandler =
              new CreateModelHandler<Infrastructure.Commands.AddAssociationCommand<ValueObjects.AddMethodDeveloperInput>, Aggregates.InstitutionMethodDeveloperAggregate>(
                  repository,
                  Events.InstitutionMethodDeveloperAdded.From,
                  Enumerable.Empty<Func<ModelRepositorySession, Id, Infrastructure.Commands.AddAssociationCommand<ValueObjects.AddMethodDeveloperInput>, CancellationToken, Task<Result<Id, Errors>>>>()
                  );
            _addPersonMethodDeveloperHandler =
              new CreateModelHandler<Infrastructure.Commands.AddAssociationCommand<ValueObjects.AddMethodDeveloperInput>, Aggregates.PersonMethodDeveloperAggregate>(
                  repository,
        ...
        public async Task<Result<TimestampedId, Errors>> Handle(
            Infrastructure.Commands.AddAssociationCommand<ValueObjects.AddMethodDeveloperInput> command,
