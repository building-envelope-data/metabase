...
namespace Metabase.GraphQl
{
      ...
      : AddOrRemoveComponentVariantInput
    {
        ...
        public static Result<Infrastructure.ValueObjects.RemoveManyToManyAssociationInput<Models.ComponentVariant>, Errors> Validate(
            RemoveComponentVariantInput self,
            IReadOnlyList<object> path
            )
        {
            return Infrastructure.ValueObjects.RemoveManyToManyAssociationInput<Models.ComponentVariant>.From(
