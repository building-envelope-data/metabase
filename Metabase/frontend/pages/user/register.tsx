...
function Register() {
    ...
    const onFinish = ({ email, password, passwordConfirmation }: { email: string, password: string, passwordConfirmation: string }) => {
        const register = async () => {
            try {
                ...
                if (!errors && !data?.registerUser?.errors && data?.registerUser?.user) {
                    await router.push(typeof returnTo === "string" ? returnTo : paths.home)
                }
            }
            catch (error) {
